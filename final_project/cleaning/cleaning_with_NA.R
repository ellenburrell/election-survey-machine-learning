...
#let's group Evan into Other


# Let's remove NA, let's remove Evan 
cleaned_data_2016_no_NA <- cleaned_data_2016 %>%
  filter(presvote16post_2016 %in% c("Did not vote for President","Donald Trump","Gary Johnson","Hillary Clinton","Jill Stein","Other"))
